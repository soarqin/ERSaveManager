 ...
 */
static uint8_t PADDING[] = {0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
 ...
 */
void md5_update(md5_ctx_t *ctx, const uint8_t *input_buffer, size_t input_len) {
    uint32_t input[16];
    ...
    for (unsigned int i = 0; i < input_len; ++i) {
        ...
        if (offset % 64 == 0) {
            for (unsigned int j = 0; j < 16; ++j) {
                ...
                input[j] = (uint32_t)(ctx->input[(j * 4) + 3]) << 24 | (uint32_t)(ctx->input[(j * 4) + 2]) << 16 | (uint32_t)(ctx->input[(j * 4) + 1]) << 8 |
...
void md5_finalize(md5_ctx_t *ctx) {
    ...
    for (unsigned int j = 0; j < 14; ++j) {
        input[j] =
            (uint32_t)(ctx->input[(j * 4) + 3]) << 24 | (uint32_t)(ctx->input[(j * 4) + 2]) << 16 | (uint32_t)(ctx->input[(j * 4) + 1]) << 8 | (uint32_t)(ctx->input[(j * 4)]);
    }
