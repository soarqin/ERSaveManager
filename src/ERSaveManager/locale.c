...
static const wchar_t *locale_strings[11][STR_MAX] = {
    /* English strings */
    {
        ...
        L"This changes the character version fields and clears UserData011 so the game can rebuild its regulation data. It does not convert newer character content. Back up the save before continuing.",
    ...
    /* French strings */
    {
        ...
        L"Les champs de version du personnage seront modifiés et UserData011 sera effacé afin que le jeu puisse reconstruire ses données de réglementation. Le contenu récent ne sera pas converti. Sauvegardez le fichier avant de continuer.",
    ...
    /* German strings */
    {
        ...
        L"Die Versionsfelder des Charakters werden geändert und UserData011 wird geleert, damit das Spiel die Regulationsdaten neu erstellen kann. Neuere Charakterinhalte werden nicht konvertiert. Sichern Sie den Spielstand vorher.",
    ...
    /* Italian strings */
    {
        ...
        L"Vengono modificati i campi di versione del personaggio e UserData011 viene svuotato affinché il gioco possa ricreare i dati di regolazione. I contenuti più recenti non vengono convertiti. Esegui prima un backup.",
    ...
    /* Spanish strings */
    {
        ...
        L"Se cambian los campos de versión del personaje y se borra UserData011 para que el juego pueda reconstruir los datos de regulación. El contenido más reciente no se convierte. Cree una copia de seguridad antes de continuar.",
    ...
    /* Portuguese strings */
    {
        ...
        L"Os campos de versão do personagem serão alterados e UserData011 será limpo para que o jogo possa reconstruir os dados de regulamentação. Conteúdo mais recente não será convertido. Faça um backup antes de continuar.",
    ...
    /* Russian strings */
    {
        ...
        L"Поля версии персонажа будут изменены, а UserData011 очищен, чтобы игра могла заново создать данные regulation. Новые данные персонажа не преобразуются. Перед продолжением создайте резервную копию.",
    ...
    /* Japanese strings */
    {
        ...
        L"キャラクターのバージョン情報を変更し、ゲームが regulation データを再構築できるよう UserData011 を消去します。新しいキャラクターデータは変換されません。続行前にバックアップしてください。",
    ...
    /* Korean strings */
    {
        ...
        L"캐릭터 다운그레이드",
        L"대상 게임 버전을 선택하세요.",
        L"캐릭터 버전 필드를 변경하고 게임이 regulation 데이터를 다시 만들 수 있도록 UserData011을 지웁니다. 최신 캐릭터 데이터는 변환하지 않습니다. 계속하기 전에 저장 파일을 백업하세요.",
    ...
    /* Simplified Chinese strings */
    {
        ...
        L"降级角色版本",
        L"选择目标游戏版本。",
        L"此操作会修改角色版本字段，并清空 UserData011，使游戏重新生成 regulation 数据；不会转换较新版本的角色内容。继续前请备份存档。",
        L"角色版本已降级",
        L"角色版本降级失败",
        L"降级存档",
    ...
    /* Traditional Chinese strings */
    {
        ...
        L"降級角色版本",
        L"選擇目標遊戲版本。",
        L"此操作會修改角色版本欄位，並清空 UserData011，讓遊戲重新產生 regulation 數據；不會轉換較新版本的角色內容。繼續前請備份存檔。",
        L"角色版本已降級",
        L"角色版本降級失敗",
        L"降級存檔",
