...
#define IDM_DLC_FLAG_START 1700
#define IDM_DOWNGRADE_CHAR 1006
#define IDM_DOWNGRADE_SAVE 1007
#define IDM_DOWNGRADE_SAVE_VERSION_START 1600 /* Full save targets, range: 1600-1699 */
#define IDM_DOWNGRADE_VERSION_START 1500 /* Target version commands, range: 1500-1599 */
